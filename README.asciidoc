...
image:https://travis-ci.org/noamt/elasticsearch-grails-plugin.svg?branch=grails-2.x["Build Status", link="https://travis-ci.org/noamt/elasticsearch-grails-plugin?branch=grails-2.x"]
