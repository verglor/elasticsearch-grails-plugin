...
* May 13, 2016
** 2.3.0
*** Upgraded to Elasticsearch 2.3.2, versioning now follow pattern described on https://github.com/noamt/elasticsearch-grails-plugin/issues/141[Issue 141]
*** Removed test classes from plugin distribution
*** elasticsearch-groovy client removed (no available compatible version, pending on https://github.com/elastic/elasticsearch-groovy/issues/35[Issue 35])
